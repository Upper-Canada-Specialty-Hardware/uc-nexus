...
def provision_install(session: Session, label: str) -> tuple[RelayInstall, str]:
    ...
    A label is all the row carries beyond the credential. The GP companies the relay serves are
    GP's to say, discovered by the relay and reported on its hello frame."""
