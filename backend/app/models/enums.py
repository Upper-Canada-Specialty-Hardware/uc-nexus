...
class PODocumentType(str, enum.Enum):
    ...
    # The slip that came off the truck with a delivery (#504). Required to create a receive draft
    # and pinned to it, so a PO with three deliveries carries three slips, each tied to its count.
