...
// #637: `companies`, not `company` - the relay reports every GP company its company master gives
// it, and every screen that used to read the single value now picks from this list.
//
